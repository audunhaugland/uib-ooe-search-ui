...
function parseFilterFromQueryParams(queryParams) {
...
function paramsToState(queryParams) {
  var state = {
    ...
    entity : "entity CMS",
    filter: parseFilterFromQueryParams(queryParams),
...
function stateToParams(_ref) {
  ...
  console.log("_ref:"+JSON.stringify(_ref));
...
var URLManager = /*#__PURE__*/function () {
  ...
  _createClass(URLManager, [{
    ...
    value: function pushStateToURL(state) {
      console.log("pushStateToURL:"+JSON.stringify(state));
